...
class ScholarshipActivityService extends ActivityService
{
    public function create($user_id, $activity_category, $activity_title, $year, $activity_description, $link) {
        ...
        $sql = "INSERT INTO `scholarship_activity` (`activity_id`, `user_id`, `points`, `activity_category`, `title`, `year`, `preview_text`, `link`) VALUES (NULL, '$user_id', '$points', '$activity_category', '$activity_title', '$year', '$activity_description', '$link')";
